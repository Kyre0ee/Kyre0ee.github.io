...
chunk0\_ptr\[0\]将GPT表项中free函数的值修改为了win函数的地址
...
![heap_unlink1_GOT表项free位置值被改](assets/image380.png)
...
![Image(29)](assets/image388.png)![Image(30)](assets/image389.png)
...
继续执行可以看到victim\_chunk已经被放在了smallbins中
